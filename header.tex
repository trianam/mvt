...
\tikzstyle{myPlace} = [place, draw=drawColor, fill=white, drop shadow]
\tikzstyle{transExpH} = [transition, draw=drawColor, fill=white, drop
shadow, minimum width=\transW, minimum height=\transH]
\tikzstyle{transExpV} = [transition, draw=drawColor, fill=white, drop
shadow, minimum width=\transH, minimum height=\transW]
\tikzstyle{transDetH} = [transition, draw=drawColor, fill=black, drop shadow, minimum width=\transW, minimum height=\transH]
\tikzstyle{transDetV} = [transition, draw=drawColor, fill=black, drop shadow, minimum width=\transH, minimum height=\transW]
\tikzstyle{pre}=[<-, very thick, >=stealth', draw=black!80]
\tikzstyle{preN}=[<-, very thick, >=o, draw=black!80]
\tikzstyle{post}=[->, very thick, >=stealth', draw=black!80]
